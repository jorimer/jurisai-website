    ...
    <main>
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-primary-950 via-primary-900 to-primary-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-primary-200 max-w-3xl mx-auto mb-12">
            {t.modulesPage.subtitle}
          </p>

          {/* Tab Navigation */}
          <div className="flex flex-wrap justify-center bg-white/10 backdrop-blur-sm rounded-edge p-1.5 gap-1 max-w-full">
            {tabs.map((tab) => (
              <button
                key={tab.key}
                onClick={() => setActiveTab(tab.key)}
                className={`px-4 sm:px-6 py-3 rounded-edge text-sm font-semibold transition-all duration-300 ${
                  activeTab === tab.key
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {t.modulesPage.modules.map((module, index) => (
                    <div
                      key={index}
                      className={`rounded-edge p-8 border transition-all hover:shadow-lg hover:scale-[1.02] ${
                        index % 2 === 1 ? "bg-paper border-rule" : "bg-white border-rule"
                      }`}
                    >
                      ...
                      <h3 className="text-xl text-primary-950 mb-3">{module.title}</h3>
                      <p className="text-sm text-primary-600 mb-6 leading-relaxed">{module.description}</p>
                      <div className="mb-6 pb-6 border-b border-rule">
                        <p className="text-xs font-semibold text-primary-400 uppercase tracking-wider">{module.stats}</p>
                      </div>
                      ...
                      <div>
                        <p className="text-xs font-semibold text-primary-400 uppercase tracking-wider mb-4">Capacidades</p>
                        <ul className="space-y-2">
                          {module.capabilities.map((capability, capIndex) => (
                            <li key={capIndex} className="flex items-start gap-3">
                              ...
                              <span className="text-sm text-primary-600">{capability}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {t.ipPage.profileMetrics.map((metric, index) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-primary-600 leading-relaxed">{metric.description}</p>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="bg-white rounded-edge p-8 border border-rule shadow-lg">
                    ...
                    <div className="mt-12 pt-8 border-t border-rule">
                      <p className="text-xs font-semibold text-primary-400 uppercase tracking-wider mb-4">Nota</p>
          ...
          <>
            <section className="py-24 bg-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {t.features.normativeItems.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="group rounded-edge p-8 bg-white border border-rule hover:border-accent-300 hover:shadow-xl transition-all"
                      >
                        <div className="w-12 h-12 rounded-edge bg-gradient-to-br from-primary-800 to-primary-900 flex items-center justify-center mb-5">
                          <svg className="w-6 h-6 text-accent-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={icons[index]} />
                          </svg>
                        </div>
                        <h3 className="text-lg text-primary-950 mb-3">{item}</h3>
                        <p className="text-sm text-primary-600 leading-relaxed">{descriptions[index]}</p>
                ...
                <div className="mt-16 bg-gradient-to-br from-primary-800 to-primary-950 rounded-edge p-10 text-center">
                  <h3 className="text-2xl text-white mb-4">Stack Tecnológico</h3>
