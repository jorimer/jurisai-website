      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm hover:text-accent-400 transition-colors">{t.footer.privacy}</a></li>
              <li><a href="#" className="text-sm hover:text-accent-400 transition-colors">{t.footer.terms}</a></li>
              <li><a href="#" className="text-sm hover:text-accent-400 transition-colors">{t.footer.cookies}</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm">
            {t.footer.madeWith} <span className="text-accent-400">&hearts;</span> {t.footer.inDR}
          </p>
        </div>
      </div>
    </footer>
