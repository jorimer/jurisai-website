...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-b from-gray-50 to-white relative">
              ...
              >
                {isPopular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="px-4 py-1 text-xs font-bold text-primary-700 bg-white rounded-full shadow-lg">
                      {t.pricing.popular}
                    </span>
                  </div>
                )}
                ...
                <div className="mb-6">
                  ...
                  {!isEnterprise && (
                    <span
                      className={`text-sm ${
                        isPopular ? "text-blue-100" : "text-gray-400"
                      }`}
                    >
                    ...
                    <li key={j} className="flex items-start gap-3">
                      <svg
                        className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                          isPopular ? "text-blue-200" : "text-primary-500"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                ...
                <Link
                  ...
                  className={`block text-center py-3 px-6 rounded-full font-semibold text-sm transition-all ${
                    isPopular
                      ? "bg-white text-primary-700 hover:bg-blue-50 shadow-lg"
                      : isEnterprise
